...
@Tag(
        ...
        description = " CRUD = create read update delete for account details"
)
public class AccountsController {
    ...
    public ResponseEntity<CustomerDto> getAccountDetails(@RequestBody Customer customerToFind) {
        CustomerDto customerDto = iAccountsService.fetchAccountByCustomerId(customerToFind);
