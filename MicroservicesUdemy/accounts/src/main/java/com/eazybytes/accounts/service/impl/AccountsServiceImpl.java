...
public class AccountsServiceImpl implements IAccountsService {
    ...
    @Override
    public CustomerDto fetchAccountByCustomerId(Customer customerToFind) {
        Customer customer = customerRepository.findById(customerToFind.getCustomerId())
                .orElseThrow(
                        () -> new ResourceNotFoundException("Customer",
                                "customerId", Integer.toString(customerToFind.getCustomerId()))
                );
        Accounts accounts = accountsRepository.findByCustomerId(customer.getCustomerId()).orElseThrow(
                () -> new ResourceNotFoundException("Account",
                        "customerId", customer.getCustomerId().toString())
